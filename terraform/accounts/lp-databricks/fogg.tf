...
provider "aws" {
  ...
  assume_role {
    role_arn = "arn:aws:iam::893455824143:role/tfe-si"
  }

  allowed_account_ids = ["893455824143"]
}
...
variable "databricks_account_id" {
  type    = string
  default = "6bae8a6a-0677-4a82-bf65-1e6e23375b4e"
}
variable "databricks_external_id" {
  type    = string
  default = "25e07f31-995a-4230-acae-842ba4e4894f"
}
...
data "terraform_remote_state" "databricks-networks" {
  backend = "remote"
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "accounts-databricks-networks"
    }

  }
}
data "terraform_remote_state" "summitps" {
  backend = "remote"
  config = {
