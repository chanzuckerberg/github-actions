...
provider "aws" {
  ...
  assume_role {
    role_arn = "arn:aws:iam::501412765515:role/tfe-si"
  }

  allowed_account_ids = ["501412765515"]
}
...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "accounts-meta-databricks-staging"
    }
...
variable "component" {
  type    = string
  default = "meta-databricks-staging"
}
variable "account" {
  type    = string
  default = "meta-databricks-staging"
...
variable "tags" {
  ...
  default = {
    ...
    env       = "accounts"
    service   = "meta-databricks-staging"
