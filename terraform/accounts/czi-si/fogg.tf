...
data "terraform_remote_state" "czi-logs" {
  backend = "remote"
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "accounts-czi-logs"
    }

  }
}
data "terraform_remote_state" "cztack-ci-1" {
  backend = "remote"
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "accounts-cztack-ci-1"
    }

  }
}
data "terraform_remote_state" "genepi-prod" {
  backend = "remote"
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "accounts-genepi-prod"
    }

  }
}
data "terraform_remote_state" "meta-2" {
  backend = "remote"
  config = {
...
data "terraform_remote_state" "rao-prod" {
  backend = "remote"
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "accounts-rao-prod"
    }

  }
}
data "terraform_remote_state" "single-cell-prod" {
  backend = "remote"
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "accounts-single-cell-prod"
    }
