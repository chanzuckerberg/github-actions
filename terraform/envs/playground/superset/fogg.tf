...
data "terraform_remote_state" "cloud-env" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "playground-cloud-env"
    }

  }
}
data "terraform_remote_state" "eks-v2" {
  backend = "remote"
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "playground-eks-v2"
    }

  }
}
data "terraform_remote_state" "k8s-core-v2" {
  backend = "remote"
  config = {
