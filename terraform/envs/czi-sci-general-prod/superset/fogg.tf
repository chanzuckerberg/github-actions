...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "czi-sci-general-prod-superset"
    }
...
variable "eks_cluster_name" {
  type    = string
  default = "ie-czi-sci-general-prod"
}
...
data "terraform_remote_state" "cloud-env" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "czi-sci-general-prod-cloud-env"
    }
...
data "terraform_remote_state" "k8s-core" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "czi-sci-general-prod-k8s-core"
    }
...
data "terraform_remote_state" "route53" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "czi-sci-general-prod-route53"
    }
