...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "staging-aws-config-generation"
    }
...
data "terraform_remote_state" "czi-id" {
  backend = "remote"
  config = {
