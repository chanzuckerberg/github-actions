...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "single-cell-prod-databricks-workspace"
    }
...
variable "tags" {
  ...
  default = {
    project   = "ie"
    env       = "single-cell-prod"
    service   = "databricks-workspace"
...
variable "databricks_external_id" {
  type    = string
  default = "4a2f419c-ae7a-49f1-b774-8f3113d9834d"
}
variable "eks_cluster_name" {
  type    = string
  default = "ie-single-cell-prod"
}
