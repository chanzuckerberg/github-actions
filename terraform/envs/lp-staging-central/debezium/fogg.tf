...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "lp-staging-central-debezium"
    }
...
variable "eks_cluster_name" {
  type    = string
  default = "ie-lp-staging-central-eks"
}
...
data "terraform_remote_state" "cloud-env" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "lp-staging-central-cloud-env"
    }
...
data "terraform_remote_state" "k8s-core" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "lp-staging-central-k8s-core"
    }
...
data "terraform_remote_state" "route53" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "lp-staging-central-route53"
    }
