...
provider "aws" {
  ...
  assume_role {
    role_arn = "arn:aws:iam::871040364337:role/tfe-si"
  }

  allowed_account_ids = ["871040364337"]
}
...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "czi-sec-staging-sastisfaction"
    }
...
data "terraform_remote_state" "cloud-env" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "czi-sec-staging-cloud-env"
    }
...
data "terraform_remote_state" "route53" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "czi-sec-staging-route53"
    }

  }
}
data "terraform_remote_state" "czi-sec" {
  backend = "remote"
  config = {
