...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "connections-staging-appflow-along-flows"
    }
...
data "terraform_remote_state" "airflow" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "connections-staging-airflow"
    }

  }
}
data "terraform_remote_state" "czi-connections" {
  backend = "remote"
  config = {
