...
terraform {
  ...
  backend "remote" {
    ...
    workspaces {
      name = "connections-staging-amundsen"
    }
...
variable "eks_cluster_name" {
  type    = string
  default = "ie-connections-staging"
}
...
data "terraform_remote_state" "cloud-env" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "connections-staging-cloud-env"
    }
...
data "terraform_remote_state" "k8s-core" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "connections-staging-k8s-core"
    }
...
data "terraform_remote_state" "route53" {
  ...
  config = {
    ...
    organization = "shared-infra"
    workspaces = {
      name = "connections-staging-route53"
    }
